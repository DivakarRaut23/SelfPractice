...
//         return book.title;
//     }
//     return books.sort(sortBooksBypublicationYear).map(bookToBookTitle);
// }
...
// console.log(`${myBook.title} is the book you were looking for`);
...
// console.log(`${myAuthor.firstName} ${myAuthor.lastName} is the author you were looking for`)

// Q4 - Create a function called getBooksByAuthor which takes the id of an author as an argument
//  and returns an array of all the books written by that author in order of the year of publication.

// function byYearofPublication (year1, year2){

//     return year1.yearOfPublication - year2.yearOfPublication;
// }
...
//     }
//     return books.filter(getAuthorById);
// }

// let booksByAuthor = getBooksByAuthor("184c518a-753f-49ce-9abb-e2e9c29fc980");

// console.log(booksByAuthor.sort(byYearofPublication));

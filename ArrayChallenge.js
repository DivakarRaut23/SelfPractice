...
let myStudent = getStudentById("f332c68b-f0ce-4e7a-9c27-2d51a92e94d0");
...
let myTeacher = getTeacherById("6ee455cc-ed20-47f7-91b7-f89b08e9dae1");
...
let myClass = getClassById("abe6da2b-6597-4083-8ea2-9fe8aed0471b");
// console.log (myClass);
...
let myTeacherInClass = getTeacherByClassId("dd798187-7880-4294-aa51-cc9ed0bc7779"); 
 console.log (myTeacherInClass);


// Q5 - Create a function called getStudentsInClass which takes a parameter called classId and returns an array of all the students in that class. A student is in a 
// class if there is an element in the studentClasses array that has a studentId that matches the student and a classId that matches the class
...
// const getStudentsInClass = classId => studentClasses.filter(sC => sC.classId == classId).map(student =>student.studentId).map(id => getStudentById(id));
// console.log(getStudentsInClass("55e63d2d-0ed6-44c5-b161-e95fdd76a2d5"));
